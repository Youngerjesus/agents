---
name: code-review
description: Comprehensive code review process utilizing specialized agents for correctness, performance, maintainability, and testing. Use this skill or command when the user asks for a code review before merging or committing changes.
...
Read and follow the guidelines defined for each of the following agents in the `.gemini/agents` directory:
- `.gemini/agents/code-reviewer.md`
- `.gemini/agents/performance-reviewer.md`
- `.gemini/agents/maintainability-reviewer.md`
